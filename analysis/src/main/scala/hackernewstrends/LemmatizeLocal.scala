...
object LemmatizeLocal extends App {
  ...
  // The year you want to crawl
  val jobQuery = "2011"
  // Point this to the folder where the dataset from the crawler is in
  val path = "/Users/bramleenders/Desktop/output_awesome/"
  ...
  tokenized.saveAsTextFile(s"/Users/bramleenders/Studie/AIM3/analysis-lda/lemmatized" + jobQuery + "/")
}
